...
export const AUTHOR = {
  ...
  reviewer: 'Пономаренко А.А.',
  headOfDepartment: 'Худойкулов З.Т.',
  city: 'Ташкент',
  country: 'Узбекистан',
  github: 'https://github.com/Ismat12345/spam-detection',
  telegram: 'https://t.me/isa_zxc',
  telegramHandle: '@isa_zxc',
  instagram: 'https://instagram.com/isa_zxc',
  instagramHandle: '@isa_zxc',
}
